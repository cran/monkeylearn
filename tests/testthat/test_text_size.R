...
test_that("Blank texts are handled properly",{
  expect_warning(monkeylearn_extract(request = "  "),
                 "You only entered blank text in the request")
  expect_message(monkeylearn_extract(request = c("  ", "I do not know what the horse is doing in the house")),
                 "The parts of your request that are only blank are not sent to the API.")


  expect_warning(monkeylearn_classify(request = "  "),
                 "You only entered blank text in the request")
  expect_message(monkeylearn_classify(request = c("  ", "I do not know what the horse is doing in the house")),
                 "The parts of your request that are only blank are not sent to the API.")
})
